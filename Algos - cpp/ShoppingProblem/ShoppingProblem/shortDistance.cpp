...
int afff = 10;
shortestDis::shortestDis(int citiesCount): numOfCities(citiesCount)
{
	min_dis = INFINITY;
...
double shortestDis::getDistanceFromCoordinates(int Sx,int Sy, int Dx, int Dy)
{
...
int shortestDis::calculateDistance(int *seq)
{
	int sum = 0;
	int index = 0;
...
void shortestDis::generateSeq(int *seq,int startIndex, int count)		
{
	int index = 0;
	int rot_count = 0;
...
void shortestDis::checkSeqAndFindShortest()
{
	int count = 0;
